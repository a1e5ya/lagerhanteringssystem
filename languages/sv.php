...
$lang_strings = array(
    ...
    'menu_home' => 'Hem',
    'menu_about' => 'Om oss',
    'menu_browse' => 'Bläddra böcker',

    // Login related
    'login' => 'Logga in',
    'staff_login' => 'Personalinloggning',
    'invalid_credentials' => 'Ogiltigt användarnamn eller lösenord. Försök igen.',
    ...
    'reset_instructions' => 'Ange din e-postadress så skickar vi instruktioner för att återställa ditt lösenord.',
    'email' => 'E-postadress',
    'send_reset_link' => 'Skicka återställningslänk',

    // Footer
    'address' => 'Köpmansgatan 12, 10300 Karis',
    'tuesday_friday' => 'Tisdag - Fredag',
    'saturday' => 'Lördag',
    'sunday_monday' => 'Söndag - Måndag',
    'closed' => 'Stängt',
    'delivery' => 'Leverans',
    'delivery_info' => 'Vi levererar via Posti enligt deras prislistor. Vi levererar även utomlands.',
    ...
    'about_p1' => 'Karis Antikvariat har ett mycket brett utbud av böcker, men vi har specialiserat oss på finlandssvenska författare, lokalhistoria och sjöfart.',
    'about_p2' => 'Vi har dessutom barn- och ungdomsböcker, serietidningar, seriealbum, DVD-filmer, CD- och vinylskivor samt samlarobjekt.',
    'about_p3' => 'Välkommen att besöka oss och upptäck vårt unika utbud!',
    'previous' => 'Föregående',
    'next' => 'Nästa',

    // Search section
    'browse_heading' => 'Bläddra i vårt sortiment',
    'search_placeholder' => 'Sök efter titel, författare eller kategori',
